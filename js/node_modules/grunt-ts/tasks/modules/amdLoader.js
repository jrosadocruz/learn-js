...
export function getReferencesInOrder(referenceFile, referencePath, generatedFiles) {
    var toreturn = {
        all: [],
        before: [],
        generated: [],
...
export function updateAmdLoader(referenceFile, files, loaderFile, loaderPath, outDir, newLine = utils.eol) {
    let commonPath;
